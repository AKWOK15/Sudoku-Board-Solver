...
public class GraphDisplay {
    ...
    public GraphDisplay(Graph g, AbstractPlayerAlgorithm pursuer, AbstractPlayerAlgorithm evader, int scale) throws InterruptedException {
    ...
    public void createCoordinateSystem() throws InterruptedException {
        ...
        HashMap<Vertex, HashMap<Vertex, Double>> distances = new HashMap<Vertex, HashMap<Vertex, Double>> ();

...
public class BetterDriver {
     ...
     * Creates random graph to simulate pursuit evasion 
     */
    public BetterDriver(int n, double p) throws InterruptedException{
        // Create a random graph on which to play
        Graph graph = new Graph(n, p);

        // Create the pursuer and evader
        AbstractPlayerAlgorithm pursuer = new BetterMoveTowardsPlayerAlgorithm(graph);
        AbstractPlayerAlgorithm evader = new BetterMoveAwayPlayerAlgorithm(graph);
